...
int main(int argc, char* argv[]) {
  ...
  for (const auto& key : keys) {
    std::vector<int> sample = input[key];

    // Insertion sort
    clock_t start = clock();
    vector<int> resultInsertion = InsertionSort(&sample);
    clock_t end = clock();
    ...
    // Merge sort
    start = clock();
    vector<int> resultMerge = MergeSort(&sample);
    end = clock();
    ...
    // Quick sort
    start = clock();
    vector<int> resultQuick = QuickSort(&sample);
    end = clock();
